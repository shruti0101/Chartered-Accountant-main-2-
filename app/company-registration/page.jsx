...
export default function CompanyRegistration() {
  ...
  const steps = [
    {
      ...
      desc: "We begin with a strategic consultation to understand your business goals, ideal structure (Private Limited, LLP, etc.), and compliance requirements.",
    },
    {
      icon: FaFileContract,
      subtitle: "Document Preparation",
      desc: "Our team collects and verifies essential documents such as PAN, Aadhaar, address proof, utility bills, and photographs of the directors/partners.",
    },
    {
      icon: FaKey,
      subtitle: "Application Filing",
      desc: "We prepare and file the incorporation application along with MOA, AOA, and other required forms with the Ministry of Corporate Affairs (MCA).",
    },
    {
      icon: FaUniversity,
      subtitle: "Certificate of Incorporation",
      desc: "Once the Registrar of Companies approves your application, we deliver your Certificate of Incorporation (COI) along with your company’s CIN.",
    },
    {
      icon: FaCheckCircle,
      subtitle: "Post‑Incorporation Support",
      desc: "We assist in setting up your current account, obtaining GST registration, MSME certification, and other regulatory licenses as per your needs.",
    },
    {
      icon: FaSmile,
      subtitle: "Compliance Advisory",
      desc: "We provide ongoing compliance support for ROC filings, annual returns, tax planning, and maintaining good standing with statutory authorities.",
    },
  ];
  ...
  return (
    <>
        ...
        <div className="grid md:grid-cols-2 md:gap-10 items-center">
          ...
          <div className="order-2 md:order-1">
            <h2 className="text-3xl mt-7 md:text-4xl font-extrabold text-[#1C398E] mb-4">
              Private Limited, LLP & Startup Company Registration Services in
              India
            </h2>
            <p className="text-gray-700 text-base md:text-lg mb-4">
              Whether you're launching a <strong>startup</strong>, forming a{" "}
              <strong>private limited company</strong>, or establishing a{" "}
              <strong>LLP</strong>, our expert team ensures a smooth
              registration process with complete legal compliance. Recognized
              startups get access to <strong>tax benefits</strong>,{" "}
              <strong>funding</strong>, and simplified compliance norms.
            </p>
            <ul className="space-y-3 text-gray-700">
              <li className="flex items-start gap-2">
                <FaCheckCircle className="text-green-600 mt-1" />
                <span>
                  <strong>Funding Access:</strong> Get listed and connect with
                  SEBI-registered venture capitalists and angel investors across
                  India.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <FaCheckCircle className="text-green-600 mt-1" />
                <span>
                  <strong>Startup India Hub:</strong> Join a central platform to
                  discover government schemes, networking opportunities, and
                  mentorship support tailored to your business.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <FaCheckCircle className="text-green-600 mt-1" />
                <span>
                  <strong>Dedicated Expert Assistance:</strong> Our team helps
                  with name approval, DIN, PAN, TAN, MOA, AOA, and every legal
                  document.
                </span>
              </li>
            </ul>
          ...
          <div className="relative w-full h-[200px] md:h-[450px] order-1 md:order-2">
            <Image
              src="/navservices/company_reg.webp"
      ...
      {/* Types */}
      <section className="w-full bg-white py-5 md:py-15 px-4 md:px-12 lg:px-24">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          ...
          <div className="relative w-full h-[200px] md:h-[450px]">
            ...
            {/* required height */}
            <Image
              src="/navservices/Types-of-business.webp"
          ...
          <div>
            ...
            <p className="text-gray-700 text-base md:text-lg mb-5">{para}</p>
