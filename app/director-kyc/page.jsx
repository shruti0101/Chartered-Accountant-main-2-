...
export default function DirectorKYC() {
  ...
  const benefits = [
    {
      ...
      description:
        "File DIR-3 KYC before the deadline to keep your Director Identification Number active.",
    },
    {
      title: "Legal Compliance",
      description: "Mandatory under Companies Act, 2013 for every DIN holder.",
    },
    {
      title: "No Penalty on Time",
      description:
        "Avoid ₹5,000 MCA late filing fee by filing before due date.",
    },
    {
      title: "Smooth Corporate Operations",
      description:
        "DIN deactivation can delay other filings like ROC, incorporation, etc.",
    },
    {
      title: "One-Time Easy Process",
      description: "Simple online process requiring basic documents and DSC.",
    },
    {
      title: "Maintain Professional Credibility",
      description:
        "Stay compliant to maintain your position in other companies too.",
    },
  ];
  ...
  const steps = [
    {
      icon: FaIdCard,
      subtitle: "Collect KYC Documents",
      desc: "PAN, Aadhaar, Passport (if applicable), Email, Mobile Number.",
    },
    {
      icon: FaLaptopCode,
      subtitle: "Digital Signature Setup",
      desc: "Ensure active DSC for signing the DIR-3 KYC form.",
    },
    {
      icon: FaFileContract,
      subtitle: "Prepare & Validate Form",
      desc: "Fill the DIR-3 KYC with accurate details and OTP verification.",
    },
    {
      icon: FaCertificate,
      subtitle: "MCA Portal Filing",
      desc: "Upload form with DSC on MCA portal and obtain SRN/Acknowledgment.",
    },
    {
      icon: FaCheckCircle,
      subtitle: "Receive Confirmation",
      desc: "Receive MCA confirmation mail with successful filing status.",
    },
    {
      icon: FaLock,
      subtitle: "Stay Compliant Yearly",
      desc: "Ensure annual eKYC is completed before every 30th September.",
    },
  ];
  ...
  const documents = [
    {
      icon: FaIdCard,
      title: "PAN Card",
      desc: "Mandatory for Indian directors.",
    },
    {
      icon: FaMapMarkedAlt,
      title: "Aadhaar Card",
      desc: "Used for OTP validation; ensure it's linked to your mobile number.",
    },
    {
      icon: FaUserShield,
      title: "Passport (If Applicable)",
      desc: "Compulsory for foreign nationals.",
    },
    {
      icon: FaLaptopCode,
      title: "Email ID & Mobile No",
      desc: "Personal contact details for OTP-based verification.",
    },
    {
      icon: FaKey,
      title: "Digital Signature (DSC)",
      desc: "Director’s DSC is mandatory for submission of the KYC form.",
    },
    {
      icon: FaFileContract,
      title: "Latest Photograph",
      desc: "Passport-size photo required in form upload.",
    },
  ];
  ...
  const filingTypes = [
    {
      ...
      title: "First-time KYC",
      subtitle: "For Directors filing DIR-3 KYC for the first time.",
    },
    {
      icon: <FaUserShield className="text-white text-3xl" />,
      title: "Annual DIR-3 KYC",
      subtitle: "Yearly compliance for all active DIN holders.",
    },
    {
      icon: <FaKey className="text-white text-3xl" />,
      title: "KYC via Web",
      subtitle: "For directors who’ve filed eKYC in previous years.",
    },
    {
      icon: <FaLock className="text-white text-3xl" />,
      title: "DIN Reactivation",
      subtitle: "Reactivation of deactivated DIN via DIR-3 KYC.",
    },
    {
      icon: <FaCertificate className="text-white text-3xl" />,
      title: "DSC Assistance",
      subtitle: "Digital Signature support for filing and verification.",
    },
    {
      icon: <FaBuilding className="text-white text-3xl" />,
      title: "Bulk KYC for Companies",
      subtitle: "KYC for all directors in Pvt Ltd, LLPs, or OPCs.",
    },
  ];
          ...
          <div className="flex flex-col lg:flex-row items-center gap-10">
            <div className="flex-1">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mb-4">
                As per MCA guidelines, every director holding a DIN must file
                their KYC annually using DIR-3 KYC. We ensure timely, error-free
                filing.
              </p>
              <p className="text-lg text-gray-600 max-w-2xl">
                Whether it’s your first KYC or regular filing, our team handles
                form prep, verification, and DSC-based filing.
              </p>
            </div>
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="text-gray-700 text-base md:text-lg mb-4">
              DIR-3 KYC verifies directors’ identity and contact details,
              ensuring compliance with the Companies Act and preventing DIN
              deactivation.
            </p>
            <ul className="space-y-3 text-gray-700">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong>Mandatory for Active DIN Holders:</strong> Annual KYC
                  is required.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <FaCheckCircle className="text-green-600 mt-1" />
                <span>
                  <strong>Avoid Deactivation & Penalties:</strong> ₹5,000 fine
                  if missed.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <FaCheckCircle className="text-green-600 mt-1" />
                <span>
                  <strong>Maintain Legal Status:</strong> Required to hold board
                  roles.
                </span>
              </li>
            </ul>
