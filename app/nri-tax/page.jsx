...
export default function NriTaxFilingPage() {
  ...
  const benefits = [
    {
      title: "Expert NRI Tax Compliance",
      description:
        "End-to-end tax filing for rental income, NRO deposits, capital gains, and Indian business interests.",
    },
    {
      title: "DTAA Advantage",
      description:
        "Lower TDS and relief from double taxation through proper treaty application and documentation.",
    },
    {
      title: "Global Income Assistance",
      description:
        "Guidance on disclosing foreign income/assets as per Indian laws (Schedule FA / Schedule TR).",
    },
    {
      title: "Faster Refunds",
      description:
        "Track refunds, minimize mismatches, and respond to IT notices efficiently.",
    },
    {
      title: "Digital & Remote Filing",
      description:
        "No physical presence needed—file from anywhere in the world via email and secure portals.",
    },
    {
      title: "Trusted Representation",
      description:
        "We liaise with the IT department for scrutiny, refund delays, and compliance notices.",
    },
  ];
  ...
  const documents = [
    {
      icon: FaFileContract,
      title: "Form 16A or Interest Certificates",
      desc: "For NRO fixed deposits, savings accounts, etc.",
    },
    {
      icon: FaUniversity,
      title: "Property Rent Agreements",
      desc: "Rental income proof for Indian properties.",
    },
    {
      icon: FaMapMarkedAlt,
      title: "Passport & Visa Pages",
      desc: "Proof of foreign stay to determine residential status.",
    },
    {
      icon: FaKey,
      title: "PAN & Aadhaar",
      desc: "Mandatory for filing ITR. Aadhaar not required for non-residents.",
    },
    {
      icon: FaLightbulb,
      title: "DTAA Proof (TRC/Form 10F)",
      desc: "If seeking DTAA relief, submit documents from the foreign country.",
    },
    {
      icon: FaRegBuilding,
      title: "Bank Statements",
      desc: "NRO/NRE account statements for income and TDS tracking.",
    },
  ];
          ...
          <div className="flex flex-col lg:flex-row items-center gap-10">
            <div className="flex-1">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mb-4">
                From NRO interest to property sale – get your Indian tax returns
                filed smoothly while abroad.{" "}
                <strong>Chintan Agrawal & Co.</strong> ensures complete NRI tax
                filing support with DTAA guidance.
              </p>
              <p className="text-lg text-gray-600 max-w-2xl">
                Hassle-free documentation, Form 26AS reconciliation, and refund
                tracking handled by qualified Chartered Accountants.
              </p>
            </div>
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="text-gray-700 text-base md:text-lg mb-4">
              If you earn any income in India — interest, rent, capital gains,
              or business — filing ITR is mandatory once you cross the exemption
              limit. It also helps claim refunds and maintain compliance.
            </p>
            <ul className="space-y-3 text-gray-700">
              <li className="flex items-start gap-2">
                <FaCheckCircle className="text-green-600 mt-1" />
                <span>
                  <strong>Refund Claims:</strong> Get back excess TDS deducted
                  on Indian earnings.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <FaCheckCircle className="text-green-600 mt-1" />
                <span>
                  <strong>Compliance:</strong> Avoid notices, penalties and stay
                  compliant with DTAA rules.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <FaCheckCircle className="text-green-600 mt-1" />
                <span>
                  <strong>Investment Proof:</strong> Maintain valid ITR for
                  future property sales, loans, or visa needs.
                </span>
              </li>
            </ul>
          </div>
