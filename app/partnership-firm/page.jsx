      ...
      content: (
        <>
          ...
          <p className="mb-4">
            ...
            and the registration process involves minimal documentation and
            fewer legal formalities compared to private limited companies or
            LLPs.
          </p>
          <h3 className="text-lg font-semibold mb-2">Low Startup Cost</h3>
          <p className="mb-4">
            Registration and operational expenses are significantly lower,
            making it ideal for small business owners, traders, freelancers, and
            service providers looking to formalize their business quickly.
          </p>
          <h3 className="text-lg font-semibold mb-2">Quick Turnaround Time</h3>
          <p>
            The entire registration process, including deed drafting and
            submission to the Registrar of Firms, can be completed in just a few
            working days.
          </p>
        </>
      ),
    },
    {
      ...
      content: (
        <>
          ...
          <p className="mb-4">
            In a partnership firm, responsibilities and roles are divided based
            on mutual agreement. This leads to better operational efficiency and
            balanced workload distribution.
          </p>
          <h3 className="text-lg font-semibold mb-2">Mutual Decision-Making</h3>
          <p className="mb-4">
            Partners jointly make strategic business decisions, reducing the
            risk of individual errors and encouraging collaboration in
            management.
          </p>
          ...
          <p>
            ...
            ensuring fairness and equal motivation among all partners.
          </p>
        </>
      ),
    },
      ...
      content: (
        <>
          <h3 className="text-lg font-semibold mb-2">
            Separate Legal Tax Status
          </h3>
          <p className="mb-4">
            A partnership firm is considered a separate taxable entity under
            Indian tax law. This allows for streamlined tax planning and
            distinct accounting from individual partners.
          </p>
          <h3 className="text-lg font-semibold mb-2">
            Salary & Interest Deductibility
          </h3>
          <p className="mb-4">
            The firm can pay salary and interest to partners as per the deed,
            and these payments are deductible as business expenses—helping
          ...
          <p>
            Unlike companies, partnership firms are not subject to DDT when
            profits are shared among partners, resulting in more efficient tax
            flow.
          </p>
        </>
      ),
    },
    {
      ...
      content: (
        <>
          ...
          <p className="mb-4">
            Once registered, the firm can obtain a PAN, TAN, and open a current
            bank account under its name, enabling formal business transactions
          ...
          <p className="mb-4">
            A registered partnership is eligible for GST registration, MSME
            registration, and other regulatory licenses that unregistered firms
            may not qualify for.
          </p>
          <h3 className="text-lg font-semibold mb-2">
            Recognized for Contracts & Tenders
          </h3>
          <p>
            Only registered partnership firms can enter into contracts, file
            legal cases, and participate in government or corporate
            tenders—enhancing business legitimacy.
          </p>
        </>
      ),
    },
    ...
    <>
        ...
        <div className="grid md:grid-cols-2 md:gap-10 items-center">
          <div>
            ...
            <p className="text-gray-700 text-base md:text-lg mb-4">
              A <strong>Partnership Firm</strong> is a popular and
              straightforward business structure for two or more individuals to
              run a business jointly. Registering a partnership firm offers
              legal recognition, enhanced credibility, and helps in smoother
            ...
            <ul className="space-y-3 text-gray-700">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong>Ease of Formation:</strong> Simple and cost-effective
                  setup process with minimal regulatory formalities.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <FaCheckCircle className="text-green-600 mt-1" />
                <span>
                  <strong>Shared Responsibilities:</strong> Workload, decisions,
                  and capital are shared among partners, making it more
                  efficient.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <FaCheckCircle className="text-green-600 mt-1" />
                <span>
                  <strong>Legal Recognition:</strong> A registered firm can file
                  suits, open a current bank account, and access government
              ...
              <li className="flex items-start gap-2">
                <FaCheckCircle className="text-green-600 mt-1" />
                <span>
                  <strong>Greater Credibility:</strong> A registered firm builds
                  trust with clients, suppliers, and financial institutions.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <FaCheckCircle className="text-green-600 mt-1" />
                <span>
                  <strong>Tax Benefits:</strong> Income is taxed at a lower rate
                  compared to individual taxation in certain cases.
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="relative w-full h-[300px] md:h-[450px] order-1 md:order-2">
            <Image
              src="/navservices/feature-psf.webp"
              alt="mis"
              fill
      ...
      <section className="bg-gray-50 py-12 px-4 md:px-10 lg:px-20">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-center text-gray-600 max-w-2xl mx-auto mb-10 text-base md:text-lg">
            Registering as a Partnership Firm offers several key benefits that
            make it a popular choice for entrepreneurs and business owners in
            India.
          </p>
      ...
      <div className=" p-3 md:p-5">
        <div className="w-full max-w-5xl mx-auto px-4 md:px-0">
          <Image
            src="/navservices/Documents-Required-psf.webp"
            alt="Documents-Required-psf"
            width={1000}
            height={500}
            className="mx-auto"
          />
