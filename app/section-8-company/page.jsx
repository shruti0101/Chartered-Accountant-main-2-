        ...
        <div className="grid md:grid-cols-2 md:gap-10 items-center">
          <div>
            ...
            <p className="text-gray-700 text-base md:text-lg mb-4">
              A <strong>Section 8 Company</strong> offers a formal legal
              structure to non-profit organizations aiming to serve society. It
              boosts credibility, provides tax benefits, and enables access to
              grants, donations, and CSR funds.
            </p>
            <ul className="space-y-3 text-gray-700">
              <li className="flex items-start gap-2">
                <FaCheckCircle className="text-green-600 mt-1" />
                <span>
                  <strong>Non-Profit Status:</strong> Perfect for NGOs and
                  social ventures with philanthropic goals.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <FaCheckCircle className="text-green-600 mt-1" />
                <span>
                  <strong>Tax Exemption:</strong> Eligible for 80G and 12A
              ...
              <li className="flex items-start gap-2">
                <FaCheckCircle className="text-green-600 mt-1" />
                <span>
                  <strong>Corporate Structure:</strong> Operates with legal
                  standing like a company but without profit motive.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <FaCheckCircle className="text-green-600 mt-1" />
                <span>
                  <strong>Grants & Donations:</strong> Builds donor trust and
                  opens doors for CSR and government funding.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <FaCheckCircle className="text-green-600 mt-1" />
                <span>
                  <strong>Separate Legal Entity:</strong> Can own assets and
        ...
        <div className="grid md:grid-cols-2 items-center gap-10 max-w-6xl mx-auto">
          ...
          <div>
            ...
            <p className="text-gray-700 text-base md:text-lg leading-relaxed">
              ...
              <strong>Certificate of Incorporation</strong> issued by the
              Ministry of Corporate Affairs (MCA) upon successful registration
              of a Section 8 Company under the Companies Act, 2013.
              <br />
              <br />
              It contains important details such as the{" "}
              <strong>Company Identification Number (CIN)</strong>, date of
              incorporation, and the official seal of the Registrar of
              Companies. This certificate acts as legal proof of your NGO’s
              existence and enables you to apply for{" "}
              <strong>80G, 12A, and FCRA registration</strong>.
              <br />
              <br />
              It is essential for opening a bank account in the organization’s
              name, receiving donations, and availing government schemes and CSR
              funds.
            </p>
          </div>
      ...
      <section className="bg-[#f9f9f9] text-gray-800 px-4 py-12">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="text-center max-w-xl mx-auto text-lg font-semibold mt-4 ">
            Section 8 Companies offer the perfect legal framework for non-profit
            organizations focused on education, healthcare, social impact, arts,
            and more.
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center mt-10">
            ...
            {/* right – image */}
                 <div className="relative w-full h-[300px] md:h-[450px] order-1 md:order-2">
                      <Image
                        src="/navservices/section-8-1.webp"
                        alt="section-8"
                        fill
                        className="rounded-xl object-contain"
                        loading="lazy"
