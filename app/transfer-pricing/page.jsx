...
export default function TransferPricingServices() {
  ...
  const benefits = [
    {
      ...
      description:
        "Avoid penalties by ensuring all international transactions meet arm’s length standards set by tax authorities.",
    },
    {
      title: "Regulatory Compliance",
      description:
        "Stay aligned with Indian and global transfer pricing documentation requirements.",
    },
    {
      title: "Strategic Tax Planning",
      description:
        "Align pricing models to your group’s tax efficiency goals while remaining compliant.",
    },
    {
      title: "Dispute Readiness",
      description:
        "Well-structured documentation protects against tax scrutiny and audits.",
    },
    {
      title: "Global Benchmarking",
      description:
        "Access reliable comparable data for defensible transfer pricing reports.",
    },
    {
      title: "End-to-End Advisory",
      description:
        "From planning to documentation to representation—we cover every stage of the TP lifecycle.",
    },
  ];
  ...
  const documents = [
    {
      icon: FaIdCard,
      title: "Group Entity List",
      desc: "Details of all associated enterprises involved in international/domestic transactions.",
    },
    {
      icon: FaMapMarkedAlt,
      title: "Agreements & Invoices",
      desc: "Copies of intercompany contracts and corresponding transactional documents.",
    },
    {
      icon: FaFileContract,
      title: "Pricing Methodology",
      desc: "Explanation of transfer pricing method adopted—CUP, TNMM, CPM, etc.",
    },
    {
      icon: FaUniversity,
      title: "Financial Statements",
      desc: "Standalone and consolidated financials of the Indian and foreign entities.",
    },
    {
      icon: FaUserShield,
      title: "Functional Analysis",
      desc: "Details of functions performed, assets used, and risks assumed by each entity.",
    },
    {
      icon: FaKey,
      title: "Industry & Economic Data",
      desc: "Supporting market data, segmental margins, and macroeconomic indicators.",
    },
  ];
  ...
  const filingTypes = [
    {
      ...
      subtitle: "Comprehensive analysis and Form 3CEB preparation",
    },
    {
      icon: <FaBuilding className="text-white text-3xl" />,
      title: "Benchmarking Report",
      subtitle: "Global comparables & economic analysis",
    },
    {
      icon: <FaStore className="text-white text-3xl" />,
      title: "TP Audit Defense",
      subtitle: "Submissions & representation during scrutiny",
    },
    {
      icon: <FaUniversity className="text-white text-3xl" />,
      title: "Policy Planning",
      subtitle: "Intercompany pricing structuring for future transactions",
    },
    {
      icon: <FaSmile className="text-white text-3xl" />,
      title: "Master File & CbCR",
      subtitle: "Support for large MNEs under BEPS requirements",
    },
    {
      icon: <FaHandshake className="text-white text-3xl" />,
      title: "Advance Pricing Agreements (APA)",
      subtitle: "Strategic assistance in applying for APAs with CBDT",
    },
  ];

  return (
    <>
      <section className="pt-29  md:mb-15">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-10">
            <div className="flex-1">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mb-4">
                Ensure your international and domestic related-party
                transactions comply with Indian TP regulations.{" "}
                <strong>Chintan Agrawal & Co.</strong> delivers expert guidance,
                accurate documentation, and audit defense.
              </p>
              <p className="text-lg text-gray-600 max-w-2xl">
                From Form 3CEB to APA, we simplify complex pricing compliance so
                you focus on global growth.
              </p>
            </div>
        ...
        <div className="grid md:grid-cols-2 md:gap-10 items-center">
          <div>
            ...
            <p className="text-gray-700 text-base md:text-lg mb-4">
              In a globalised economy, intercompany transactions must reflect
              fair market value. Failure to comply with Indian TP laws can lead
              to heavy penalties and litigation.
            </p>
            <ul className="space-y-3 text-gray-700">
              <li className="flex items-start gap-2">
                <FaCheckCircle className="text-green-600 mt-1" />
                <span>
                  <strong>Avoid Adjustments:</strong> Prevent tax additions due
                  to underreported profits in India.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <FaCheckCircle className="text-green-600 mt-1" />
                <span>
                  <strong>International Credibility:</strong> Demonstrate
                  compliance to investors, regulators, and partners.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <FaCheckCircle className="text-green-600 mt-1" />
                <span>
                  <strong>Peace of Mind:</strong> Navigate assessments and
                  audits with solid documentation and expert advice.
                </span>
              </li>
            </ul>
          </div>
      ...
      <section className="bg-[#f9f9f9]  mt-4 text-gray-800 px-4 py-8 md:py-12">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="text-center max-w-3xl mx-auto text-lg font-semibold mt-4 ">
            Our step-by-step methodology ensures your related-party transactions
            meet global transfer pricing standards and Indian tax compliance
            requirements.
          </p>
