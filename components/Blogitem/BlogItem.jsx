      ...
      <div className="mt-13 md:mt-20 max-w-[330px] sm:max-w-[300px] mx-5 bg-white border border-black hover:shadow-[-7px_7px_0px_#000000]">
        <Link href={`/knowledge/${id}`}>
          ...
          <div className="p-5">
            ...
            <div
              className="mb-3 tracking-tight text-sm text-gray-700 line-clamp-3"
              dangerouslySetInnerHTML={{
                __html: DOMPurify.sanitize(description),
              }}
            />

            <div className="cursor-pointer  gap-2 inline-flex items-center py-2 font-semibold text-center">
